...
contract RSETHPoolV3WithNativeChainBridge is ERC20Upgradeable, AccessControlUpgradeable, ReentrancyGuardUpgradeable {
    ...
    event FeesWithdrawn(uint256 feeEarnedInToken, address token);
    event AssetsMovedForBridging(uint256 ethBalanceMinusFees);
    event AssetsMovedForBridging(uint256 tokenBalanceMinusFees, address indexed token);
    ...
    /// @param _l1VaultETHForL2Chain The L1Vault address for this L2 chain
